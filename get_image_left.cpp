 ...
 * https://stackoverflow.com/questions/31133903/opencv-remove-background
 */
Mat Solver::apply_mask(Mat image, Mat mask, int shift) {
    ...
    threshold(mask, mask_thresholded, THRESHOLD, 255, CV_THRESH_BINARY);
        // maxval = 255
    imwrite("imgs/2_mask_left_thresholded.jpg", mask_thresholded);
    ...
    imwrite("imgs/3_mask_left_thresholded_bordered.jpg", mask_thresholded_bordered);
    ...
    imwrite("imgs/4_mask_left_thresholded_bordered_closed.jpg", mask_thresholded_bordered);
